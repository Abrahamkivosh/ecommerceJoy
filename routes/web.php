...
Route::post('/client/product/review/{product}',[PageController::class, 'reviewAdd' ])->name('client.review.add') ;

Route::get('/client/product/{product}',[PageController::class, 'product' ])->name('client.product') ;
Route::get('client/checkout',[PageController::class,'checkout'])->name('client.checkout') ;
