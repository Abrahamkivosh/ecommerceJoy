                ...
                @guest
                    <form class="row contact_form" action="{{ route('login') }}" method="post">
                        ...
                        <div class="col-md-12 form-group">
                            ...
                            <a class="lost_pass" href="{{ route('password.request') }}">Lost your password?</a>
                        </div>
                    </form>
                @endguest
...
@push('custom-scripts')
    ...
    <script>
        ...
        // hide data-placeholder="Phone number" on #phone focus and value is not empty
        $("#phone").on("focus", function() {
            if ($(this).val() != "") {
                $(this).next().hide();
                // hide data-placeholder="Phone number" on #phone blur and value is empty
