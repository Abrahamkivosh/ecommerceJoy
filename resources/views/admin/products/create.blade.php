                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="weight" value="{{old('weight')}}" class="form-control" id="product_weight"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="stock" value="{{old('stock')}}" class="form-control" id="product_stock"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea name="description" class="form-control" value="{{old('description')}}" id="" cols="30" rows="3"></textarea>
                            </div>
                        </div>
                    </div>
